...
/* No-console build: all message functions are silent no-ops. */

void pyi_debug_message(const char *fmt, ...) { (void)fmt; }
void pyi_warning_message(const char *fmt, ...) { (void)fmt; }
void pyi_error_message(const char *fmt, ...) { (void)fmt; }
void pyi_perror_message(const char *funcname, int error_code, const char *fmt, ...) { (void)funcname; (void)error_code; (void)fmt; }

void pyi_debug_message_w(const wchar_t *fmt, ...) { (void)fmt; }
void pyi_warning_message_w(const wchar_t *fmt, ...) { (void)fmt; }
void pyi_error_message_w(const wchar_t *fmt, ...) { (void)fmt; }
void pyi_perror_message_w(const wchar_t *funcname, int error_code, const wchar_t *fmt, ...) { (void)funcname; (void)error_code; (void)fmt; }
void pyi_winerror_message_w(const wchar_t *funcname, DWORD error_code, const wchar_t *fmt, ...) { (void)funcname; (void)error_code; (void)fmt; }
